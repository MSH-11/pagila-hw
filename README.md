# pagila-hw ![https://github.com/MSH-11/pagila-hw/actions?query=workflow%3Atests](https://github.com/MSH-11/pagila-hw/workflows/tests/badge.svg)
...
1. Fork this repository and clone it on the lambda server.
